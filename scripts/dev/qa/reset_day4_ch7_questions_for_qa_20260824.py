...
def main() -> None:
    ...
    print(f"[INFO] target username={USERNAME!r}, topic={TOPIC!r}, theme={THEME!r}, chapter={CHAPTER_NUMBER}")
    ...
    with psycopg.connect(database_url, connect_timeout=10) as conn:
        with conn.cursor() as cur:
            ...
            if not user_row:
                raise RuntimeError(f"사용자 {USERNAME!r}를 찾지 못했습니다.")
